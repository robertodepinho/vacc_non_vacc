...
```
Podemos repetir com hospitalizações e morte a pergunta que fizemos antes:  É possível que a maior parte das pessoas hospitalizadas ou mortas tenha sido vacinada? E 100% delas? Quando isso acontece? 
...
```
Vamos e trazer de volta o grupo todo. Vamos observar o quanto representa o total de hospitalizações e mortes entre pessoas vacinadas e não vacinas. 
